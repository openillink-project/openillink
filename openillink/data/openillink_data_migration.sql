...
-- localizations
-------------------------------------------------------------------------------
INSERT INTO your_database_name.localizations (`code`,`id`,`library`,`name1`,`name2`,`name3`,`name4`,`name5`)
SELECT `code`,`id`,`library`,`name1`,`name2`,`name3`,`name4`,`name5` FROM openillink_v2.localizations;

-------------------------------------------------------------------------------
-- status
-------------------------------------------------------------------------------
INSERT INTO your_database_name.status (`code`,`color`,`help1`,`help2`,`help3`,`help4`,`help5`, `id`, `in`, `out`, `special`, `title1`,`title2`,`title3`,`title4`,`title5`, `trash`)
...
-- units
-------------------------------------------------------------------------------
INSERT INTO your_database_name.units (`code`,`department`,`externalipdisplay`,`faculty`,`id`,`internalip1display`,`internalip2display`, `library`,`name1`,`name2`,`name3`,`name4`,`name5`, `validation`)
...
-- users
-------------------------------------------------------------------------------
INSERT INTO your_database_name.users (`admin`,`created_ip`,`created_on`,`email`,`library`,`login`,`name`, `password`,`status`,`user_id`)
