    ...
    if (($monaut == "admin")||($monaut == "sadmin")){
        ...
        if (($action == "update")||($action == "new")){
                ...
                if ($action == "update"){
                    if ($id != ""){
                        ...
                        if ($nb == 1){
                            ...
                            $resultupdate = dbquery($query, $params,'sssssssi') or die("Error : ".mysqli_error(dbconnect()));
            ...
            if ($action == "new"){
                ...
                $query ="INSERT INTO `localizations` (`name1`, `name2`, `name3`, `name4`, `name5`, `code`, `library`) VALUES (?, ?, ?, ?, ?, ?, ?)";
                $params = array($name1, $name2, $name3, $name4, $name5, $code, $library);
                $id = dbquery($query, $params, 'sssssss') or die("Error : ".mysqli_error(dbconnect()));
                echo "<center><br/><b><font color=\"green\">\n";
