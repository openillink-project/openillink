    ...
    if (($monaut == "admin")||($monaut == "sadmin")){
        if ($id!=""){
            ...
            if ($nb == 1){
                ...
                echo "</td></tr>\n";
                echo "<tr><td class=\"odd\"><b>".$guiLabelName1[$lang]." *</b></td><td class=\"odd\"><input name=\"title1\" type=\"text\" size=\"60\" value=\"" . $name["fr"] . "\"></td></tr>\n";
                echo "<tr><td><b>".$guiLabelHelp1[$lang]."</b></td><td><input name=\"help1\" type=\"text\" size=\"60\" value=\"" . $help["fr"] . "\"></td></tr>\n";
                echo "<tr><td class=\"odd\"><b>".$guiLabelName2[$lang]."</b></td><td class=\"odd\"><input name=\"title2\" type=\"text\" size=\"60\" value=\"" . $name["en"] . "\"></td></tr>\n";
                echo "<tr><td><b>".$guiLabelHelp2[$lang]."</b></td><td><input name=\"help2\" type=\"text\" size=\"60\" value=\"" . $help["en"] . "\"></td></tr>\n";
                echo "<tr><td class=\"odd\"><b>".$guiLabelName3[$lang]."</b></td><td class=\"odd\"><input name=\"title3\" type=\"text\" size=\"60\" value=\"" . $name["de"] . "\"></td></tr>\n";
                echo "<tr><td><b>".$guiLabelHelp3[$lang]."</b></td><td><input name=\"help3\" type=\"text\" size=\"60\" value=\"" . $help["de"] . "\"></td></tr>\n";
                echo "<tr><td class=\"odd\"><b>".$guiLabelName4[$lang]."</b></td><td class=\"odd\"><input name=\"title4\" type=\"text\" size=\"60\" value=\"" . $name["it"] . "\"></td></tr>\n";
                echo "<tr><td><b>".$guiLabelHelp4[$lang]."</b></td><td><input name=\"help4\" type=\"text\" size=\"60\" value=\"" . $help["it"] . "\"></td></tr>\n";
                echo "<tr><td class=\"odd\"><b>".$guiLabelName5[$lang]."</b></td><td class=\"odd\"><input name=\"title5\" type=\"text\" size=\"60\" value=\"" . $name["es"] . "\"></td></tr>\n";
                echo "<tr><td><b>".$guiLabelHelp5[$lang]."</b></td><td><input name=\"help5\" type=\"text\" size=\"60\" value=\"" . $help["es"] . "\"></td></tr>\n";
                ...
                echo "</select>\n";
                echo "</td></tr>\n";
                echo "<tr><td><b>".$guiColor[$lang]."</b></td><td><input name=\"color\" type=\"text\" size=\"60\" value=\"" . $color . "\"></td></tr>\n";
                echo "<tr><td>&nbsp;</td><td>&nbsp;</td></tr>\n";
                echo "<tr><td></td><td><input type=\"submit\" value=\"Enregistrer les modifications\">\n";
                echo "&nbsp;&nbsp;<input type=\"button\" value=\"Annuler\" onClick=\"self.location='list.php?table=status'\">\n";
                echo "&nbsp;&nbsp;<input type=\"button\" value=\"Supprimer\" onClick=\"self.location='update.php?action=delete&table=status&id=" . $statusid . "'\"></td></tr>\n";
